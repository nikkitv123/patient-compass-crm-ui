...
export const ManagementDashboard = ({ currentUser }: ManagementDashboardProps) => {
  ...
  const teamWorkload = [
    { name: "Jane Smith", caseCount: 12, taskCount: 8 },
    { name: "Robert Johnson", caseCount: 9, taskCount: 15 },
    { name: "Emily Davis", caseCount: 7, taskCount: 4 },
    { name: "Michael Brown", caseCount: 10, taskCount: 11 },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <CaseList 
          title="Cases At Risk / Breached SLA"
      ...
      <div>
        <TaskList 
          title="Team Tasks Due Soon" 
          description="Tasks assigned to team members with upcoming deadlines"
          tasks={tasks}
          showAssignee={true}
        />
      </div>
