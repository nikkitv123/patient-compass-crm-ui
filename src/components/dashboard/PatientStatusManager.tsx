...
export const PatientStatusManager = () => {
  ...
  const criticalPatients = [
    { id: "p1", name: "Sarah Johnson", status: "Critical", lastSeen: "2 hours ago" },
    { id: "p2", name: "Michael Chen", status: "Stable", lastSeen: "1 day ago" },
    { id: "p3", name: "Emma Davis", status: "Monitoring", lastSeen: "3 hours ago" },
  ];
