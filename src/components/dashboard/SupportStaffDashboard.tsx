...
export const SupportStaffDashboard = ({ currentUser }: SupportStaffDashboardProps) => {
            ...
            <CardContent className="px-0 pt-0">
              <div className="space-y-4">
                {communications.map((comm) => (
                  <div key={comm.id} className="flex gap-4 px-6 py-2 hover:bg-muted/50">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="text-xs text-muted-foreground flex items-center gap-1">
                        ...
                        <button
                          ...
                          onClick={() => navigate(`/cases/${comm.case.id}`)}
                        >
                          {comm.case.caseId}
                        </button>
                        <span>•</span>
                        ...
                        <button
                          className="text-primary hover:underline"
                          onClick={() => navigate(`/patients/${comm.patient.id}`)}
                        >
                          {comm.patient.name}
                        </button>
                      </div>
