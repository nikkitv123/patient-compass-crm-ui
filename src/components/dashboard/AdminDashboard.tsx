...
import { Activity, Users, Database, Server, Clock, ClipboardList, BellRing, FileText, Settings, MessageSquare, Shield } from "lucide-react";
...
export const AdminDashboard = ({
  ...
  return <div className="space-y-6">
      ...
      <div className="relative w-full max-w-md mx-auto lg:mx-0">
        <input type="text" placeholder="Search audit logs, users or configurations..." className="w-full h-10 pl-10 pr-4 text-gray-900 placeholder-gray-500 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-slate-100" />
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
        <StatsCard title="Total Users" value="127" icon={Users} trend={{
        value: 3,
        isPositive: true
      }} description="active accounts" />
        <StatsCard title="Failed Logins" value="12" icon={Shield} trend={{
        value: 5,
        isPositive: false
      }} description="last 24 hours" />
        <StatsCard title="Audit Log Events" value="1,432" icon={FileText} description="last 24 hours" />
        <StatsCard title="Open Cases" value="178" icon={ClipboardList} trend={{
        value: 12,
        isPositive: false
      }} description="system-wide" />
        <StatsCard title="Tasks Overdue" value="34" icon={Clock} trend={{
        value: 9,
        isPositive: false
      }} description="system-wide" />
        <StatsCard title="Integration Status" value="3/4" icon={Activity} description="systems operational" />
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {systemComponents.map((component, index) => <div key={index} className="flex items-center justify-between">
      ...
      <Card>
        ...
        <CardContent className="px-0">
          <div className="space-y-1">
            {systemActivities.map(activity => <div key={activity.id} className="px-6 py-4 hover:bg-muted/50">
